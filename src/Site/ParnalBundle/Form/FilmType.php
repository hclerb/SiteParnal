...
class FilmType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
	    ...
	    ->add('conseille', 'choice', array('choices'=>array(0=>"Nothing",1=>'Adultes',2=>'Ado - Adultes',3=>'Ado',4=>'Famille',5=>'Jeune Public')))
            ...
            ->add('synopsis','textarea',array('attr' => array('class' => 'tinymce','data-theme'=>'simple','cols' => "70", 'rows' => "15",'required' => false)))
            ->add('critique','textarea', array('attr' => array('class' => 'tinymce','data-theme'=>'simple','cols' => "70", 'rows' => "15",'required' => false)))
            ->add('image','text', array('read_only' => true))
            ->add('file','file')    
    ...
    {
        return 'site_parnalbundle_filmtype';
    }
}
